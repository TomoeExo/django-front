	...
	return (
		<div>
			{isLoading ? (
				...
				<div className='flex items-center  outline outline-1 outline-COLORS-stroke_main rounded-md px-3 py-3 justify-start bg-COLORS-bg_color_app text-white/80 gap-3 relative'>
